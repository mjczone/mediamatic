...
/// <summary>
///  Provides ZipFile specific vfs methods.
/// </summary>
public class ZipFileMethodsFactory : VfsMethodsFactoryBase
{
    /// <summary>
    ...
    {
        return vfs is ZipFileVfsConnection;
    }
